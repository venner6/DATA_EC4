...
**Para la data de datos de entrenamiento:**

```{r}
summary(df_train)
```

**Para la data de datos de prueba:**
...
matrixCM_train_reglog <- confusionMatrix(data = y_train_reglog_bin,reference = dfclass_train$aboveFour)
...
matrixCM_test_reglog <- confusionMatrix(data = y_test_reglog_bin,reference = dfclass_test$aboveFour)
...
matrixCM_train_classTreeCV <- confusionMatrix(data = y_train_pred_classTreeCV,reference = dfclass_train$aboveFour)
...
matrixCM_test_classTreeCV <- confusionMatrix(data = y_test_pred_classTreeCV,reference = dfclass_test$aboveFour)

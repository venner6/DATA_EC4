...
y_test_tree_bin <- TODO
y_test_treeCV_bin <- TODO
```
...
R2_test_tree_bin <- TODO
MAE_test_tree_bin <- TODO
...
```{r}
# COMENTARIO AQUI
y_test_baseline <- TODO

# COMENTARIO AQUI
y_test_baseline <- factor(y_test_baseline, levels = c(0, 1))

# COMENTARIO AQUI
dfclass_test$aboveFour <- TODO
```
...
y_test_LR_bin <-  factor(y_test_LR_bin, levels = c(0,1))
...
y_test_tree_bin <-  factor(y_test_tree_bin, levels = c(0,1))

matrixCM_test_tree <- confusionMatrix(data = TODO, 
                           reference = dfclass_test$aboveFour)
...
matrixCM_test_treeCV <- confusionMatrix(data = TODO, 
                           reference = TODO)
